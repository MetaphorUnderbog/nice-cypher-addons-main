...
## [1.0.0]- 2026-07-02
- Updated the module to work with Cyphersystem 2.2.0 on Foundry v14
- Updated the code in module_creation.js to use a fully qualified path to reference a function that couldn't be found in Foundry v14
